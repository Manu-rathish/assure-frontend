...
import type { IdrDocument } from "@/lib/types/idr";

interface IdrDocumentRailProps {
  documents: IdrDocument[];
  activeDocId: string;
  onSelect: (docId: string) => void;
}

export function IdrDocumentRail({
  documents,
  activeDocId,
  onSelect,
}: IdrDocumentRailProps) {
